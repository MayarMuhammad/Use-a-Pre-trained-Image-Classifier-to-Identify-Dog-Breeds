...
def get_pet_labels(image_dir):
    ...
    for idx in range(0, len(in_files), 1):
        ...
        if [idx][0] != ".":
            ...
            #remove any of these characters "_123456789" from pet label and replace any "_" to " " to give 
            #appropriate pet label 
            pet_label_old = in_files[idx].lower().split("_")
            for word in pet_label_old:
               if word.isalpha():
                  pet_label += word + " "
